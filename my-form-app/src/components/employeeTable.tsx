    ...
    <>   {/* Header with title and static search bar */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div className="bg-white rounded-xl shadow-sm border border-indigo-100 p-4 flex items-center justify-between">
          <div>
            <p className="text-indigo-500 text-sm font-medium">Total Employees</p>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-indigo-100 p-4 flex items-center justify-between">
          <div>
            <p className="text-indigo-500 text-sm font-medium">Male Employees</p>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-indigo-100 p-4 flex items-center justify-between">
          <div>
            <p className="text-indigo-500 text-sm font-medium">Female Employees</p>
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center gap-1">
                      <span className="text-sm font-medium text-indigo-800">{employee.salary}</span>
